...
public class TestAbstractAccount {
    public static void main(String[] args) {
        ...
        AbstractAccount sa = new SavingsAccount("SAV1001", "Rajesh Sharma", 28, 10000.0,
                "ACTIVE", "1234", 500.0, 4.0);
        try {
            sa.withdraw(2000.0, "1234");
            System.out.println("[Savings] Withdraw 2000: SUCCESS | Balance: Rs " + sa.getBalance());
        } catch (AccountException e) {
            System.out.println("[Savings] [FAIL] " + e.getMessage());
        }
        ...
        AbstractAccount ca = new CurrentAccount("CUR1001", "Priya Patel", 34, 2000.0,
                "ACTIVE", "5678", 10000.0);
        try {
            ca.withdraw(5000.0, "5678");
            System.out.println("[Current] Overdraft debit: SUCCESS | Balance: Rs " + ca.getBalance());
        } catch (AccountException e) {
            System.out.println("[Current] [FAIL] " + e.getMessage());
        }

        AbstractAccount fda = new FixedDepositAccount("FD1001", "Amit Kumar", 45, 50000.0,
                "ACTIVE", "1111", 12, 6.5);
        try {
