...
public class TestAccountRulesEngine {
    public static void main(String[] args) {
        ...
        for (int tenure : tenures) {
            double minimumBalance = AccountRulesEngine.getSavingsMinBalance(tenure);
            double interestRate = AccountRulesEngine.getSavingsInterestRate(tenure);
            System.out.println("Tenure " + tenure + " yrs -> Min Balance: Rs "
                    + minimumBalance + " | Interest: " + interestRate + "%");
        }
